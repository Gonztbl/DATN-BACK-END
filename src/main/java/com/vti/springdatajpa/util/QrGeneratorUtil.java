...
public class QrGeneratorUtil {
    ...
    public static String buildQrPayload(String userId, String walletId, String name, String accountNumber, Double amount, String note) {
        StringBuilder payload = new StringBuilder("walletapp://pay?version=1");

        payload.append("&userId=").append(urlEncode(userId));
