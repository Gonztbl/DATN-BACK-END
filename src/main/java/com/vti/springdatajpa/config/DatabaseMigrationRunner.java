...
public class DatabaseMigrationRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            jdbcTemplate.execute("ALTER TABLE products MODIFY COLUMN image_base64 LONGTEXT;");
        ...
        for (String table : tables) {
            try {
                ...
                if (table.equals("transfer_details")) {
                    ...
                    try {
                        jdbcTemplate.execute("ALTER TABLE " + table + " MODIFY COLUMN counterparty_wallet_id INT;");
                ...
                jdbcTemplate.execute("ALTER TABLE " + table + " MODIFY COLUMN " + col + " INT;");
