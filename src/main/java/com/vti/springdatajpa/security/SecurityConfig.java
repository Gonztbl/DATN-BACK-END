...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Temporary: Allow admin categories, restaurants, and products for testing
                        // NOTE: Specific permitAll() rules MUST come BEFORE the general /api/admin/**
                        // rule
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173", "http://localhost:5175", "http://localhost:3000")); // frontend
